...
<Image src="/images/assoc.jpg" alt="Logo AAMD" width={500} height={200} />
   ...
   <div class={styles.grid}>
     ...
     target="_blank" class={styles.card} rel="noopener noreferrer">
     ...
     class={styles.card} rel="noopener noreferrer">
     <p>
...
de autorização, sendo vedada a interferência estatal em seu funcionamento”
     ...
     <a
       ...
       class={styles.card} target="_blank" rel="noopener noreferrer">
